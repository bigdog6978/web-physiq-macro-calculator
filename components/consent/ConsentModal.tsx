...
export function ConsentModal() {
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="w-full max-w-md rounded-2xl border-2 border-card-border bg-card p-6 shadow-xl"
      ...
      >
        ...
        <div className="space-y-4 mb-6">
          <div className="flex items-center justify-between">
            ...
            <input
              ...
              checked
              disabled
              className="h-4 w-4 rounded border-card-border bg-input-bg"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-muted-foreground">Google Ads / AdSense</p>
            </div>
            <button
              type="button"
              role="switch"
              ...
              className={`relative h-6 w-11 rounded-full transition-colors ${
                advertising ? "bg-primary" : "bg-muted"
              }`}
            >
              <span
                className={`absolute top-1 left-1 h-4 w-4 rounded-full bg-white transition-transform ${
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button
            type="button"
            onClick={acceptAll}
            className={`${btnBase} border-2 border-card-border text-muted-foreground hover:border-muted-foreground/30 hover:text-foreground`}
