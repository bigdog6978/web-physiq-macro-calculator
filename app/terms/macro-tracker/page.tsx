...
export const metadata: Metadata = {
  title: "Terms of Use - Macro Tracker | Free Macro Calculator",
  description: "Terms of use for the Macro Tracker.",
};
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12">
      ...
      <div className="max-w-none text-[#A3A3A3] space-y-4">
        <p>
          [Placeholder: Terms of use content for Macro Tracker will be uploaded here.]
        </p>
        <p>
          This page will contain the full terms of use specific to the Macro Tracker product.
        </p>
      </div>
      <p className="mt-8">
